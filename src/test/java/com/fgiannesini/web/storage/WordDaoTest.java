...
public class WordDaoTest {
    ...
    void should_convert_to_Word() {
        ...
        Word expected = new Word("acender", "allumer", 1, LocalDateTime.of(2024, 11, 2, 16, 20, 7), 1, 2.5f, 3);
        Assertions.assertEquals(wordDao.toWord(), expected);
    }

    @Test
    void should_build_from_Word() {
        Word word = new Word("acender", "allumer", 1, LocalDateTime.of(2024, 11, 2, 16, 20, 7), 1, 2.5f, 3);
    ...
    void should_apply_default_ease_factor_when_zero() {
        ...
        Assertions.assertEquals(2.5f, actual.easeFactor());
        Assertions.assertEquals(1, actual.intervalDays());
    }
}
